...
#                                                                             
# PROGRAMMER: adams wakhungu
# DATE CREATED:21/06/2023
# REVISED DATE:22/06/2023 
...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("Percentage of Correctly Classified Dogs: {:.2f}%".format(results_stats_dic['pct_correct_dogs']))
    print("Percentage of Correctly Classified Dog Breeds: {:.2f}%".format(results_stats_dic['pct_correct_breed']))
    print("Percentage of Correctly Classified Not-a-Dog Images: {:.2f}%".format(results_stats_dic['pct_correct_notdogs']))
    print("Percentage of Match between Pet and Classifier Labels: {:.2f}%".format(results_stats_dic['pct_match']))
